...
//				graph.printGraph();
				...
				// start of BFS
				System.out.println("\nUsing BFS:");
				Result newResultBFS = new Result(graph.size(),graph.density(),graph.numOfNonStopFlights());
				...
				Result newResultDFS = new Result(graph.size(),graph.density(),graph.numOfNonStopFlights());
